...
def prepare_training_data(
    processed_data: pd.DataFrame, branch_id: str
...
def evaluate_model(
    model: Sequential, X_val: np.ndarray, y_val: np.ndarray, branch_id: str
) -> Dict:
    print("\nEvaluating model...")
...
def save_model_artifacts(
    model: Sequential, branch_id: str, metrics: Dict, training_history: Dict
):
